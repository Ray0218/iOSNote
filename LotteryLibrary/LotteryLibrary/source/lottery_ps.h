...
#pragma mark - 订单详情
         ...
         *  @return <0表示失败, >=0表示成功
         */
        int GetOrderTarget(int order, int index, PsSubtype &subtype, int &note, int num1[PS_NUMBER_COUNT], int num2[PS_NUMBER_COUNT], int num3[PS_NUMBER_COUNT]);
        /**
         *  删除一个子订单
         *
         *  @param order [in]订单索引
