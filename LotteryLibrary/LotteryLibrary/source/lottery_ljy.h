...
namespace lottlib {
    ...
    public:
         ...
         *  @return cmdId
         */
        int NwRefresh(NetworkCaller caller);
...
#pragma mark - 订单详情
         ...
         *  @return <0表示失败, >=0表示成功
         */
        int GetOrderTarget(int order, int index, int &note, int num1[LJY_NUMBER_COUNT], int num2[LJY_NUMBER_COUNT], int num3[LJY_NUMBER_COUNT],
                      int num4[LJY_NUMBER_COUNT], int num5[LJY_NUMBER_COUNT], int num6[LJY_NUMBER_COUNT], int num7[LJY_NUMBER_COUNT]);
        /**
         *  删除一个子订单
         *
    ...
    private:
        int cbkRefresh(int result, Message msg);
